...
/**
 * Prices committed from `GET /v1/models/catalog` (2026-08-21). Catalog values are in credits;
 * everything on the wire is microcredits. Refresh with `hydratePricing`.
 */
...
/** Replaces prices from a freshly fetched catalog. Unparseable entries are left as committed. */
